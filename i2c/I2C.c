...
void I2C_unimaster_error_handler(uint8_t _TWSR_ERROR_CODE_);
/********************************************************************
...
/********************************************************************************
********************************************************************************/
void I2C_unimaster_tx_byte(uint8_t _Byte_)
{
    TWDR = _Byte_;
...
/********************************************************************************
********************************************************************************/
int8_t I2C_unimaster_tx_data(uint8_t Data)
{
...
int8_t I2C_unimaster_tx_addrslave(uint8_t SlaveAddress_RW)
{
	uint8_t I2C_STATUS_CODE_R_W;
...
int8_t I2C_unimaster_rx_data(uint8_t PrepararACK_NACK)
{
	uint8_t I2C_StatusCode_R_ACK_NACK;
