...
void INA238_init(void)
{
	...
	ina238_reg = (IN238_CONFIG_ADCRANGE_163p84mV<<INA238_CONFIG_BIT_ADCRANGE);
...
*/
	/*
	ina238_reg = 	(INA238_ADC_CONFIGMODE_CONTINUOUS_SHUNT_ONLY<<INA238_ADC_CONFIG_BIT_MODE) | \
			 	(INA238_ADC_CONFIGMODE_CT_50uS<<INA238_ADC_CONFIG_BIT_VSHCT) | \
				(INA238_ADC_CONFIGMODE_AVG_SAMPLE_1024 << INA238_ADC_CONFIG_BIT_AVG);
	*/
	ina238_reg = 	(INA238_ADC_CONFIGMODE_CONTINUOUS_SHUNT_ONLY<<INA238_ADC_CONFIG_BIT_MODE) | \
				 	(INA238_ADC_CONFIGMODE_CT_150uS<<INA238_ADC_CONFIG_BIT_VSHCT) | \
	...
	/////////////////////////////////////
	reg[0] = (uint8_t)( ((uint16_t)INA238_SHUNT_CAL_ADCRANGE_163p84mV)>>8);
	reg[1] = (uint8_t)(INA238_SHUNT_CAL_ADCRANGE_163p84mV);
